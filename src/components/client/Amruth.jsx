  ...
  return (
    <div className=' py-6 bg-[#f4f5ff]'>
        <div className=' px-4 mb-4'>
            <h1 className=' pl-2 lg:pl-16 xl:pl-32 text-3xl font-semibold text-primary py-3'> <span className=' primary-font text-orange-600'>Amruth Noni</span>  associated with the services: </h1>
