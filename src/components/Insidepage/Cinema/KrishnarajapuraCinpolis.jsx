...
function KrishnarajapuraCinpolis() {
  const cardInfos = [
    {
      cardImage:
  ...
  return (
    <section className=" w-full mt-[72px]">
      <Insidepage
        ...
        description={
          "Cinepolis Nexus Shantiniketan, Screen - 1, Krishnarajapura Ad is an engaging way for brands to reach out to customers during the trailers while entering the movie theatre, finding their seats, and settling in. Cinema ads deliver high-impact advertising option that offers a mass reach by catering to potential customers who spend a lot of dwell time in a theatre."
        }
        users={"108 No. of Seats"}
        cardInfos={cardInfos}
      />
    </section>
  );
...
export default KrishnarajapuraCinpolis;
