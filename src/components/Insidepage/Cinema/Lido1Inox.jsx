    ...
    const cardInfos = [
      ...
      return (
        <section className=" w-full mt-[72px]">
          <Insidepage
            headerText={
              "Advertising in PVR INOX Lido Mall, Screen - 1, Jogupalya"
            }
            image={cinema}
            title={
              "About Advertising in PVR INOX Lido Mall, Screen - 1, Jogupalya : "
            }
            description={
              "PVR INOX Lido Mall, Screen - 1, Jogupalya Ad is an engaging way for brands to reach out to customers during the trailers while entering the movie theatre, finding their seats, and settling in. Cinema ads deliver high-impact advertising option that offers a mass reach by catering to potential customers who spend a lot of dwell time in a theatre."
            }
            users={"353 No. of Seats"}
            cardInfos={cardInfos}
          />
        </section>
      );
