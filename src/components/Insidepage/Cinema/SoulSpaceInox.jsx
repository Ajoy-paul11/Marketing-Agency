...
function SoulSpaceInox() {
  ...
  return (
    <section className=" w-full mt-[72px]">
      <Insidepage
        headerText={
          "Advertising in PVR INOX Soul Space Spirit Central Mall, Screen - 4, Bellandur"
        }
        image={cinema}
        title={
          "About Advertising in PVR INOX Soul Space Spirit Central Mall, Screen - 4, Bellandur : "
        }
        description={
          "PVR INOX Soul Space Spirit Central Mall, Screen - 4, Bellandur Ad is an engaging way for brands to reach out to customers during the trailers while entering the movie theatre, finding their seats, and settling in. Cinema ads deliver high-impact advertising option that offers a mass reach by catering to potential customers who spend a lot of dwell time in a theatre."
        }
        users={"82 No. of Seats"}
        cardInfos={cardInfos}
      />
    </section>
  );
