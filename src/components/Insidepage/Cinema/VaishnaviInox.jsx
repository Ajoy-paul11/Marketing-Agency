    ...
    const cardInfos = [
      ...
      return (
        <section className=" w-full mt-[72px]">
          <Insidepage
            headerText={
              "Advertising in PVR INOX Vaishnavi Sapphire Mall, Screen - 6, Yeswanthpur"
            }
            image={cinema}
            title={
              "About Advertising in PVR INOX Vaishnavi Sapphire Mall, Screen - 6, Yeswanthpur : "
            }
            description={
