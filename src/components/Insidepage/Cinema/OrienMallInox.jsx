...
function OrienMallInox() {
  ...
  return (
    <section className=" w-full mt-[72px]">
      <Insidepage
        headerText={
          "Advertising in PVR INOX Orion Mall, Screen - 7, Rajajinagar"
        }
        image={cinema}
        title={
          "About Advertising in PVR INOX Orion Mall, Screen - 7, Rajajinagar : "
        }
        description={
          "You will get the rate for advertising in Orion Mall, Malleshwaram, Malleswaram West, Bengaluru in the Media Options and Pricing section of the website. The mentioned rates are for per second of airtime. So e.g. if the cost to advertise in Orion Mall, Malleshwaram, Malleswaram West, Bengaluru is mentioned as Rs 300/sec and your ad is 10 sec long, the cost for playing your ad once on Orion Mall, Malleshwaram, Malleswaram West, Bengaluru come to Rs 300 X 10 = Rs 3,000."
        }
        users={"387 No. of Seats"}
        cardInfos={cardInfos}
      />
    </section>
  );
