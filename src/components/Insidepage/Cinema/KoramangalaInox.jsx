...
function KoramangalaInox() {
    const cardInfos = [
        ...
        },
        {
            ...
            price: "1,350 Per Poster",
          },
      ];
      return (
        <section className=" w-full mt-[72px]">
          <Insidepage
            headerText={"Advertising in PVR INOX Forum Mall, Screen - 1, Koramangala"}
            image={cinema}
            title={"About Advertising in PVR INOX Forum Mall, Screen - 1, Koramangala : "}
            description={
