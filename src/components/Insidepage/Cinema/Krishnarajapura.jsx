...
function Krishnarajapura() {
    const cardInfos = [
        ...
        },
        {
            ...
            price: "975 Per Poster",
          },
      ];
      return (
        <section className=" w-full mt-[72px]">
          <Insidepage
            headerText={"Advertising in PVR INOX Phoenix Market City Mall, Screen - 6, Krishnarajapura"}
            image={cinema}
            title={"About Advertising in PVR INOX Phoenix Market City Mall, Screen - 6, Krishnarajapura : "}
            description={
...
export default Krishnarajapura