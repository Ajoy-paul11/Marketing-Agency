  ...
  return (
    <section className=" relative w-full py-10">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className=" relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-10">
          <div className="mt-6 w-80 shadow-[0px_0px_10px_rgba(0,0,0,0.25)] rounded-lg">
            ...
            <div>
              <div className="mb-2 text-xl">UI/UX Review Check</div>
              <div>
          ...
          <div className="mt-6 w-80 shadow-[0px_0px_10px_rgba(0,0,0,0.25)] rounded-lg">
            <div className="">
              <div>
                <div className="">
                  <img
                    src="https://images.unsplash.com/photo-1742827871492-72428a28106b?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="card-image"
                    className={` w-full h-full object-cover rounded-t-lg`}
                    onClick={() =>
                      openModal(
                        "https://images.unsplash.com/photo-1742827871492-72428a28106b?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      )
                    }
                  />
                </div>
      ...
      {isModalOpen && (
        ...
        >
          <div
            className="relative max-w-4xl w-full p-[120px]"
