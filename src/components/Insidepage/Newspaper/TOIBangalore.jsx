    ...
    const cardInfos = [
        ...
        },
        {
          cardImage:
            ...
            about: 
                "The Times of India offers innovative Half Page Vertical Bookmark Ads that have a prominent half-page space, accompanied by an extra strip, ensuring visibility on any newspaper page. These vertical strip Ads have a total area of approx.1021.8 sq. cm, present advertisers with more customization possibilities. Compared to Half-page ads, these Ads will have more ad space, in which advertisers can customize the content and make it eye-catching to the audience.",
