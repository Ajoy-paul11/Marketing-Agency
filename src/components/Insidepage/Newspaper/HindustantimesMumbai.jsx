...
import hindustantimesMumbai from "../../../assets/Newspaper/hindustan.jpg";
import ScrollToTop from "../../ScrollToTop";

function HindustantimesMumbai() {
  const cardInfos = [
    {
      cardImage:
  ...
  return (
    <section className=" w-full mt-[72px]">
      <ScrollToTop />
      <Insidepage
        headerText={"Advertising in Hindustan Times, Mumbai"}
        image={hindustantimesMumbai}
        title={"About Advertising in Hindustan Times, Mumbai : "}
        description={
          "Hindustan Times, Mumbai, English with a circulation of around 625000 is one of the most popular English newspaper. Hindustan Times, Mumbai, English helps build trustworthiness through association covering different topics. This newspaper helps showcase ads to a wide audience, improving visibility and delivering high impact by prompting potential customers in making purchases."
        }
        users={"625K Circulation"}
        cardInfos={cardInfos}
      />
    </section>
  );
...
export default HindustantimesMumbai;
