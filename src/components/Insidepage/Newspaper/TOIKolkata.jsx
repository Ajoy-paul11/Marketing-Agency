...
import toiKolkata from '../../../assets/Newspaper/toi.jpg'
    ...
    const cardInfos = [
      ...
      return (
        <section className=" w-full mt-[72px]">
          <Insidepage
            headerText={"Advertising in Times Of India, Kolkata"}
            image={toiKolkata}
            title={"About Advertising in Times Of India, Kolkata : "}
            description={
              "Times Of India, Kolkata, English with a circulation of around 173265 is one of the most popular English newspaper. Times Of India, Kolkata, English helps build trustworthiness through association covering different topics. This newspaper helps showcase ads to a wide audience, improving visibility and delivering high impact by prompting potential customers in making purchases."
            }
            users={"173.3K Circulation"}
            cardInfos={cardInfos}
          />
        </section>
      );
