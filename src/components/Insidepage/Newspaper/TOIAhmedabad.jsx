...
import toiAhmedabad from '../../../assets/Newspaper/toi.jpg'

function TOIAhmedabad() {
    const cardInfos = [
        {
          cardImage:
      ...
      return (
        <section className=" w-full mt-[72px]">
          <Insidepage
            headerText={"Advertising in Times Of India, Ahmedabad"}   
            image={toiAhmedabad}
            title={"About Advertising in Times Of India, Ahmedabad : "}
            description={
              "Times Of India, Ahmedabad, English with a circulation of around 123956 is one of the most popular English newspaper. Times Of India, Ahmedabad, English helps build trustworthiness through association covering different topics. This newspaper helps showcase ads to a wide audience, improving visibility and delivering high impact by prompting potential customers in making purchases."
            }
            users={"124K Circulation"}
            cardInfos={cardInfos}
          />
        </section>
      );
