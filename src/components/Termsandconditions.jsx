...
function Termsandconditions() {
  return (
    <section className="max-w-3xl mx-auto p-6 shadow rounded-lg my-6 bg-[#f4f5ff]/80 text-primary primary-font mt-[120px]">
      ...
      <p className="mb-4">
        Welcome to Mindblue. By accessing or using our website and services, you
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="mb-2">
            ...
            an account to access certain features of our Services. You agree to
          ...
          <p>
            ...
            complete a Know Your Customer (KYC) verification process. Failure to
            provide accurate KYC information may result in the suspension or
        ...
        <div>
          ...
          <p className="mb-2">
            ...
            processed securely through Razorpay. By making a payment, you agree
            to Razorpay's terms and conditions in addition to these Terms.
          </p>
          <p className="mb-2">
            <strong>Billing Information:</strong> You agree to provide current,
            complete, and accurate billing and payment information.
          </p>
          <p className="mb-2">
        ...
        <div>
          ...
          <p className="mb-2">
            <strong>Permissible Use:</strong> You agree to use our Services only
            for lawful purposes and in accordance with these Terms. You must not
            use the Services in any way that could damage, disable, overburden,
            or impair our website or interfere with any other party's use of the
            Services.
          </p>
          <p>
            <strong>Prohibited Activities:</strong> Unauthorized commercial use,
            data scraping, or other activities that disrupt our services are
            strictly prohibited.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>
            ...
            liabilities, costs, or debt arising from your use of the Services or
