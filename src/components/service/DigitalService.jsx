    ...
    <div className="w-full mt-[75px]">
      ...
      <div className=" px-4  xl:px-20 2xl:px-44 py-14 bg-[#f4f5ff]">
        ...
        <div className=" grid grid-cols-1 gap-y-4 md:grid-cols-2 lg:grid-cols-3 justify-items-center lg:px-16">
          ...
          <ServiceTemplate
            img={"https://ik.imagekit.io/ajoy/Digital/seo.png?updatedAt=1743156462113"}
            title="SEO"
          ...
          <ServiceTemplate
            img={"https://ik.imagekit.io/ajoy/Digital/google-Ad-288-x-192.jpg?updatedAt=1743156368085"}
            title="Google Ads"
          ...
          <ServiceTemplate
            img={"https://ik.imagekit.io/ajoy/Digital/meta-288-x-192.jpg?updatedAt=1743156368150"}
            title="Meta Ads"
          ...
          <ServiceTemplate
            img={"https://ik.imagekit.io/ajoy/Digital/spotify-288-x-192.jpg?updatedAt=1743156368056"}
            title="Spotify Ads"
          ...
          />
          <ServiceTemplate
            img={"https://ik.imagekit.io/ajoy/Digital/hotstar-288-x-192.jpg?updatedAt=1743156367808"}
            title="Hotstar Ads"
