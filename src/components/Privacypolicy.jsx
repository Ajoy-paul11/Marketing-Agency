    ...
    <>
      ...
      <div className="max-w-3xl mx-auto p-6 shadow rounded-lg my-6 bg-[#f4f5ff]/80 text-primary primary-font mt-[120px]">
        ...
        <p className="mb-4">
          ...
          outlines how we collect, use, and share your information when you
          access our website and use our Services.
        </p>
        <div className="space-y-6">
          <div>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                account, complete our KYC verification, or make a payment, we
                collect personal details including your name, address, email,
                phone number, government-issued identification, and other
                necessary documents.
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                ...
                your account, transactions, updates, and marketing (subject to
                your consent where required).
              </li>
              <li>
                <strong>Compliance:</strong> To comply with legal obligations,
                including anti-fraud measures, KYC/AML regulations, and
                financial reporting.
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>Third-Party Processors:</strong> We share your
                information with trusted third-party service providers (such as
                Razorpay) strictly for processing payments and performing KYC
                verification.
              </li>
              <li>
              ...
              <li>
                ...
                any significant changes regarding the use of your personal data.
              </li>
            </ul>
          </div>
          <div>
            ...
            <p>
              All payment transactions are securely handled by Razorpay. By
              making a payment, you agree to Razorpay's own privacy policy and
              terms of service. We encourage you to review their policies to
              understand how they process and protect your payment information.
            </p>
          </div>
          <div>
            <h2 className="text-2xl font-semibold mb-2 font-secondary text-primary">
            ...
            <p>
              ...
              collecting government-issued identification and other documents.
              We use this information solely for identity verification and fraud
              prevention purposes and maintain strict confidentiality and
              security measures.
            </p>
          </div>
          <div>
